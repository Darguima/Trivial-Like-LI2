...
typedef enum distanciaArma { // Este struc tem as possíveis distancias nas quais as armas funcionam
	Melee,
	Curta,
	Media,
	Longa,
...
/* // o segunite é deixado caso seja preciso

Arma punhos = {Melee, 7, 50, "Um par de punhos que, nas mãos adequadas, fazem grandes estragos "};

Arma garras = {Curta, 25, 60, "Garras ensanguentadas que saem das mãos de um grotesco monstro. Urghh..."};

Arma espadaOxidada = {Media,  35, 75, "Espada que pertenceu a um soldado caído em combate."};

Arma espadaLonga = {Media, 30, 95, "Espada forjada pelos melhores ferreiros. Embora não seja muito potente, raramente falha ao seu portador."};

Arma arco = {MuitoLonga, 50, 25, "Um arco bastante flexível que causa muito dano mas possui uma terrível precisão."};

Arma acido = {Longa, 45, 20, "Um líquido lançado por certos monstros que desfaz tudo o que toca."};

Arma cetro = {Longa, 15, 100, "Um cetro carregado de magia. O seu baixo dano é compensado com a precisão dos seus projéteis."};*/

Arma armas[] = {
	{Punhos ,Melee, 7, 50, "Um par de punhos que, nas mãos adequadas, fazem grandes estragos "}, // 0
	{Garras, Curta, 20, 60, "Garras ensanguentadas que saem das mãos de um grotesco monstro. Urghh..."}, // 1
	{EspadaOxidada, Media,  25, 75, "Espada que pertenceu a um soldado caído em combate."}, // 2
	{EspadaLonga, Media, 30, 95, "Espada forjada pelos melhores ferreiros. Embora não seja muito potente, raramente falha ao seu portador."}, // 3
	{Arco, MuitoLonga, 45, 30, "Um arco bastante flexível que causa muito dano mas possui uma terrível precisão."}, // 4
	{Acido, Longa, 40, 15, "Um líquido lançado por certos monstros que desfaz tudo o que toca."}, // 5
	{Cetro, Longa, 15, 100, "Um cetro carregado de magia. O seu baixo dano é compensado com a precisão dos seus projéteis."} // 6
};
...
typedef enum elementosDoMapa {
	Jogador, /* @ */
	Mobs, /* depende do tipo do mob - com foreground ou background vermelho */
	NPC, /* & */
	Paredes, /* # */
