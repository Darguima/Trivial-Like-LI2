...
Mob const vampiro1 = {Vampiro, "Vampiro", 'V', garras, 70, 70, 3};
...
Mob const aranha1 = {Aranha, "Aranha", 'A', acido, 15, 15, 10};
Mob const aranha2 = {Aranha, "Aranha", 'A', acido, 20, 20, 6};
Mob const zombie1 = {Zombie, "Zombie", 'Z', garras, 70, 70, 2};
Mob const demonio = {Demonio, "Demonio", 'D', aniquiladora, 120, 120, 3};
Mob const morte = {Morte, "Morte", 'W', foice, 170, 170, 4};
